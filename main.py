...
from src.Admin.routers import (
    employer_requests_router,
    admin_employer_requests_router,
)
from src.applications.routers import (
    resume_router,
    application_router,
)
...
api_v1.include_router(employer_requests_router)
api_v1.include_router(admin_employer_requests_router)
...
def read_root():
    return {
        "message": "welcome to my job board project"
    }
